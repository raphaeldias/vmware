...
/*
 * VMware change: Unused now, we don't force linkage to any data
 * library.
 */
#ifdef _WIN32
               ...
               UErrorCode *pErrorCode)
{
    ...
    /*
     * VMware change: We don't link the shared library version of the
     * data file, don't try to load it.
     */
#if 0
    /* ??????? TODO revisit this */ 
    if (isICUData) {
