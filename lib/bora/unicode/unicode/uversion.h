...
/*
 * VMware change: Move the copyright define upwards so that it can be
 * included in the uversion.h.license file, and thus not fire off the
 * addLicense.py copyright checker.
 */
